...
var dino = {
    ...
    draw(){
        //ctx.fillStyle = 'white';
        ctx.fillStyle = "rgba(255, 255, 255, 0 )"; // transparent the user image background
        ctx.fillRect(this.x, this.y, this.width, this.height);
        ctx.drawImage(userImg, 0, 0, 75, 100, this.x, this.y, 50, 100);
    }
}
...
class Cactus{
    ...
    draw(){
        //ctx.fillStyle = 'white';
        ctx.fillStyle = "rgba(255, 255, 255, 0 )"; // transparent the poop background
        ctx.fillRect(this.x, this.y, this.width, this.height);
